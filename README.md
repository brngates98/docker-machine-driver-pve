...
| `--pve-cloud-init`        | `PVE_CLOUD_INIT`        | *unset*                            | Optional cloud-init user-data source (filepath or URL).                                                              |
| `--pve-cloud-config`      | `PVE_CLOUD_CONFIG`      | *unset*                            | Optional filepath to a cloud-config YAML file to merge into user-data.                                               |
